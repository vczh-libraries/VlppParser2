...
#define CASE(LABEL, ...)\
		...
		CASE(LeftRecursionPlaceholderMixedWithSwitches, ruleName, placeholder, targetRuleName);
		CASE(LeftRecursionInjectHasNoContinuation, ruleName, placeholder, targetRuleName);
		...
		CASE(LiteralNotValidToken, ruleName, name);
		CASE(LiteralIsDiscardedToken, ruleName, name);
