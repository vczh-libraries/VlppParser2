	...
	namespace glr
	{
		namespace parsergen
		{
			...
			enum class ParserGenFields : vl::vint32_t
			{
				...
				PushConditionSyntax_switches = 37,
				PushConditionSyntax_syntax = 38,
				RefCondition_name = 39,
				RefSyntax_field = 40,
				RefSyntax_literal = 41,
				RefSyntax_refType = 42,
				ReuseClause_assignments = 43,
				ReuseClause_syntax = 44,
				Rule_clauses = 45,
				Rule_name = 46,
				Rule_type = 47,
				SequenceSyntax_first = 48,
				SequenceSyntax_second = 49,
				SwitchItem_name = 50,
				SwitchItem_value = 51,
				SyntaxFile_rules = 52,
				SyntaxFile_switches = 53,
				TestConditionBranch_condition = 54,
				TestConditionBranch_syntax = 55,
				TestConditionSyntax_branches = 56,
				Type_name = 57,
				UseSyntax_name = 58,
			};
