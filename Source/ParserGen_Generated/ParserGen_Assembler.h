	...
	namespace glr
	{
		namespace parsergen
		{
			...
			enum class ParserGenFields : vl::vint32_t
			{
				...
				Rule_name = 43,
				Rule_type = 44,
				SequenceSyntax_first = 45,
				SequenceSyntax_second = 46,
				SwitchItem_name = 47,
				SwitchItem_value = 48,
				SyntaxFile_rules = 49,
				SyntaxFile_switches = 50,
				TestConditionBranch_condition = 51,
				TestConditionBranch_syntax = 52,
				TestConditionSyntax_branches = 53,
				Type_name = 54,
				UseSyntax_name = 55,
			};
