	...
	namespace glr
	{
		namespace parsergen
		{
			...
			enum class ParserGenFields : vl::vint32_t
			{
				...
				Class_ambiguity = (static_cast<vl::vint32_t>(ParserGenClasses::Class) << 8) + 0,
				Class_baseClass = (static_cast<vl::vint32_t>(ParserGenClasses::Class) << 8) + 1,
				Class_props = (static_cast<vl::vint32_t>(ParserGenClasses::Class) << 8) + 2,
				...
				OptionalSyntax_priority = (static_cast<vl::vint32_t>(ParserGenClasses::OptionalSyntax) << 8) + 0,
				OptionalSyntax_syntax = (static_cast<vl::vint32_t>(ParserGenClasses::OptionalSyntax) << 8) + 1,
