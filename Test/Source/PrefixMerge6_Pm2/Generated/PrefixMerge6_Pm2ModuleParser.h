...
namespace prefixmerge6_pm2
{
	enum class ModuleParserStates
	{
		...
		_Expr = 61,
		Module = 72,
		_ExprNoComma_LRI_Isolated_1 = 89,
		_LongType_LRI_Original = 93,
		_Expr0_LRI_Original = 107,
		_Expr1_LRI_Original = 117,
		_Expr2_LRI_Original = 125,
		_ExprNoComma_LRI_Original = 131,
		_Expr_LRI_Original = 136,
		Module_LRI_Original = 142,
		_Expr0__LongType_LRI_Prefix = 146,
	};
