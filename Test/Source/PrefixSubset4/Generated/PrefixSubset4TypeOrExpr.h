...
#ifndef VCZH_PARSER2_UNITTEST_PREFIXSUBSET4_TYPEOREXPR_AST
#define VCZH_PARSER2_UNITTEST_PREFIXSUBSET4_TYPEOREXPR_AST
...
namespace vl
{
	namespace reflection
	{
		namespace description
		{
			...
			DECL_TYPE_INFO(prefixsubset4::TypeOrExpr)
			DECL_TYPE_INFO(prefixsubset4::TypeOrExpr::IVisitor)
			DECL_TYPE_INFO(prefixsubset4::QualifiedName)
			DECL_TYPE_INFO(prefixsubset4::QualifiedName::IVisitor)
			DECL_TYPE_INFO(prefixsubset4::Name)
			DECL_TYPE_INFO(prefixsubset4::MemberName)
			DECL_TYPE_INFO(prefixsubset4::CallExpr)
			DECL_TYPE_INFO(prefixsubset4::CtorExpr)
			DECL_TYPE_INFO(prefixsubset4::MulExpr)
			DECL_TYPE_INFO(prefixsubset4::ConstType)
			DECL_TYPE_INFO(prefixsubset4::PointerType)
			DECL_TYPE_INFO(prefixsubset4::FunctionType)
			DECL_TYPE_INFO(prefixsubset4::TypeOrExprToResolve)

#ifdef VCZH_DESCRIPTABLEOBJECT_WITH_METADATA

			BEGIN_INTERFACE_PROXY_NOPARENT_SHAREDPTR(prefixsubset4::TypeOrExpr::IVisitor)
				void Visit(prefixsubset4::TypeOrExprToResolve* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

				void Visit(prefixsubset4::QualifiedName* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

				void Visit(prefixsubset4::CallExpr* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

				void Visit(prefixsubset4::CtorExpr* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

				void Visit(prefixsubset4::MulExpr* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

				void Visit(prefixsubset4::ConstType* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

				void Visit(prefixsubset4::PointerType* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

				void Visit(prefixsubset4::FunctionType* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

			END_INTERFACE_PROXY(prefixsubset4::TypeOrExpr::IVisitor)

			BEGIN_INTERFACE_PROXY_NOPARENT_SHAREDPTR(prefixsubset4::QualifiedName::IVisitor)
				void Visit(prefixsubset4::Name* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

				void Visit(prefixsubset4::MemberName* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

			END_INTERFACE_PROXY(prefixsubset4::QualifiedName::IVisitor)

#endif
#endif
			/// <summary>Load all reflectable AST types, only available when <b>VCZH_DEBUG_NO_REFLECTION</b> is off.</summary>
			/// <returns>Returns true if this operation succeeded.</returns>
			extern bool PrefixSubset4TypeOrExprLoadTypes();
		}
	}
}
#endif