...
{
	bool PrefixSubset4TokenDeleter(vl::vint token)
	{
		switch((PrefixSubset4Tokens)token)
		{
		case PrefixSubset4Tokens::SPACE:
			return true;
		default:
			return false;
		}
	...
	const wchar_t* PrefixSubset4TokenId(PrefixSubset4Tokens token)
	{
		...
		return 0 <= index && index < PrefixSubset4TokenCount ? results[index] : nullptr;
	}

	const wchar_t* PrefixSubset4TokenDisplayText(PrefixSubset4Tokens token)
	{
		static const wchar_t* results[] = {
			L"(",
			L")",
	...
	const wchar_t* PrefixSubset4TokenRegex(PrefixSubset4Tokens token)
	{
		static const wchar_t* results[] = {
			L"/(",
			L"/)",
	...
	void PrefixSubset4LexerData(vl::stream::IStream& outputStream)
	{
