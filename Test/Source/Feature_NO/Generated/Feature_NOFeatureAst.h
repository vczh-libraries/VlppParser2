...
#ifndef VCZH_PARSER2_UNITTEST_FEATURE_NO_FEATUREAST_AST
#define VCZH_PARSER2_UNITTEST_FEATURE_NO_FEATUREAST_AST
...
namespace vl::reflection::description
{
	...
	DECL_TYPE_INFO(feature_no::Plus)
	DECL_TYPE_INFO(feature_no::Feature)
	DECL_TYPE_INFO(feature_no::Feature::IVisitor)
	DECL_TYPE_INFO(feature_no::FeatureToResolve)
	DECL_TYPE_INFO(feature_no::NestedOptionalFeature)

#ifdef VCZH_DESCRIPTABLEOBJECT_WITH_METADATA

	BEGIN_INTERFACE_PROXY_NOPARENT_SHAREDPTR(feature_no::Feature::IVisitor)
		void Visit(feature_no::FeatureToResolve* node) override
		{
			INVOKE_INTERFACE_PROXY(Visit, node);
		}

		void Visit(feature_no::NestedOptionalFeature* node) override
		{
			INVOKE_INTERFACE_PROXY(Visit, node);
		}

	END_INTERFACE_PROXY(feature_no::Feature::IVisitor)

#endif
#endif
	/// <summary>Load all reflectable AST types, only available when <b>VCZH_DEBUG_NO_REFLECTION</b> is off.</summary>
	/// <returns>Returns true if this operation succeeded.</returns>
	extern bool Feature_NOFeatureAstLoadTypes();
}
#endif