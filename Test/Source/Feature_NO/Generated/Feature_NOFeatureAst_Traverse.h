...
#ifndef VCZH_PARSER2_UNITTEST_FEATURE_NO_FEATUREAST_AST_TRAVERSE_VISITOR
#define VCZH_PARSER2_UNITTEST_FEATURE_NO_FEATUREAST_AST_TRAVERSE_VISITOR

#include "Feature_NOFeatureAst.h"

namespace feature_no::traverse_visitor
{
