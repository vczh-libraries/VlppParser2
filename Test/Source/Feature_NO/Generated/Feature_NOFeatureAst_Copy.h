...
#ifndef VCZH_PARSER2_UNITTEST_FEATURE_NO_FEATUREAST_AST_COPY_VISITOR
#define VCZH_PARSER2_UNITTEST_FEATURE_NO_FEATUREAST_AST_COPY_VISITOR

#include "Feature_NOFeatureAst.h"

namespace feature_no::copy_visitor
{
