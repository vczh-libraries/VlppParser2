...
#ifndef VCZH_PARSER2_UNITTEST_FEATURE_PWL_FEATUREAST_AST_JSON
#define VCZH_PARSER2_UNITTEST_FEATURE_PWL_FEATUREAST_AST_JSON
...
namespace feature_pwl
{
	...
	namespace json_reader
	{
		...
		protected:
			...
			virtual void FillFields(PwlFeature* node);
