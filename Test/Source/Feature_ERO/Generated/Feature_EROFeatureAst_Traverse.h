...
#ifndef VCZH_PARSER2_UNITTEST_FEATURE_ERO_FEATUREAST_AST_TRAVERSE_VISITOR
#define VCZH_PARSER2_UNITTEST_FEATURE_ERO_FEATUREAST_AST_TRAVERSE_VISITOR

#include "Feature_EROFeatureAst.h"

namespace feature_ero::traverse_visitor
{
