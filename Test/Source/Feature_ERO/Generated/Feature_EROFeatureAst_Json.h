...
#ifndef VCZH_PARSER2_UNITTEST_FEATURE_ERO_FEATUREAST_AST_JSON
#define VCZH_PARSER2_UNITTEST_FEATURE_ERO_FEATUREAST_AST_JSON
...
namespace feature_ero
{
	...
	namespace json_reader
	{
		...
		protected:
			...
			virtual void FillFields(BranchedOptionalFeature* node);
