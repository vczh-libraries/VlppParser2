...
#include "PrefixMerge7_PmSwitchTypeOrExpr_Traverse.h"
...
namespace prefixmerge7_pmswitch
{
	namespace traverse_visitor
	{
		...
		void TypeOrExprVisitor::Traverse(CommaExpr* node) {}
		...
		void TypeOrExprVisitor::Traverse(GtExpr* node) {}
		void TypeOrExprVisitor::Traverse(LtExpr* node) {}
		...
		void TypeOrExprVisitor::Traverse(ThrowExpr* node) {}
		...
		void TypeOrExprVisitor::Finishing(CommaExpr* node) {}
		...
		void TypeOrExprVisitor::Finishing(GtExpr* node) {}
		void TypeOrExprVisitor::Finishing(LtExpr* node) {}
		...
		void TypeOrExprVisitor::Finishing(ThrowExpr* node) {}
		...
		void TypeOrExprVisitor::Visit(LtExpr* node)
		{
			...
			Traverse(static_cast<vl::glr::ParsingAstBase*>(node));
			Traverse(static_cast<TypeOrExpr*>(node));
			Traverse(static_cast<LtExpr*>(node));
			InspectInto(node->first.Obj());
			InspectInto(node->second.Obj());
			Finishing(static_cast<LtExpr*>(node));
			Finishing(static_cast<TypeOrExpr*>(node));
			Finishing(static_cast<vl::glr::ParsingAstBase*>(node));
		}
		...
		void TypeOrExprVisitor::Visit(GtExpr* node)
		{
			...
			Traverse(static_cast<vl::glr::ParsingAstBase*>(node));
			Traverse(static_cast<TypeOrExpr*>(node));
			Traverse(static_cast<GtExpr*>(node));
			InspectInto(node->first.Obj());
			InspectInto(node->second.Obj());
			Finishing(static_cast<GtExpr*>(node));
			Finishing(static_cast<TypeOrExpr*>(node));
			Finishing(static_cast<vl::glr::ParsingAstBase*>(node));
		}
		...
		void TypeOrExprVisitor::Visit(ThrowExpr* node)
		{
			...
			Traverse(static_cast<vl::glr::ParsingAstBase*>(node));
			Traverse(static_cast<TypeOrExpr*>(node));
			Traverse(static_cast<ThrowExpr*>(node));
			for (auto&& listItem : node->arg)
			{
				InspectInto(listItem.Obj());
			}
			Finishing(static_cast<ThrowExpr*>(node));
			Finishing(static_cast<TypeOrExpr*>(node));
			Finishing(static_cast<vl::glr::ParsingAstBase*>(node));
		}
		...
		void TypeOrExprVisitor::Visit(CommaExpr* node)
		{
			...
			Traverse(static_cast<vl::glr::ParsingAstBase*>(node));
			Traverse(static_cast<TypeOrExpr*>(node));
			Traverse(static_cast<CommaExpr*>(node));
			InspectInto(node->first.Obj());
			InspectInto(node->second.Obj());
			Finishing(static_cast<CommaExpr*>(node));
			Finishing(static_cast<TypeOrExpr*>(node));
			Finishing(static_cast<vl::glr::ParsingAstBase*>(node));
		}
