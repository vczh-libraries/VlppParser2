...
#include "PrefixMerge7_PmSwitchTypeOrExpr_Json.h"
	...
	namespace json_reader
	{
		...
		void TypeOrExprVisitor::ValidateFields(vl::glr::json::JsonObject* json, const vl::WString& typeName)
		{
			...
			for (auto field : json->fields)
			{
				...
				else if (typeName == L"LtExpr")
				{
					fieldFound = fieldFound || name == L"first";
					fieldFound = fieldFound || name == L"second";
				}
				else if (typeName == L"GtExpr")
				{
					fieldFound = fieldFound || name == L"first";
					fieldFound = fieldFound || name == L"second";
				}
				...
				{
					fieldFound = fieldFound || name == L"arg";
				}
				else if (typeName == L"CommaExpr")
				{
					fieldFound = fieldFound || name == L"first";
					fieldFound = fieldFound || name == L"second";
				}
		...
		void TypeOrExprVisitor::FillFields(CallExpr* node)
		{
			...
			if (auto value = FindField(vl::WString::Unmanaged(L"args")))
			{
				...
				for (auto item : jsonArray->items)
				{
					if (IsNull(item.Obj()))
					{
						node->args.Add(vl::Ptr<TypeOrExpr>());
					}
		...
		void TypeOrExprVisitor::FillFields(CommaExpr* node)
		{
			FillFields(static_cast<TypeOrExpr*>(node));
		...
		void TypeOrExprVisitor::FillFields(GtExpr* node)
		{
			FillFields(static_cast<TypeOrExpr*>(node));
			if (auto value = FindField(vl::WString::Unmanaged(L"first")))
			{
		...
		void TypeOrExprVisitor::FillFields(LtExpr* node)
		{
			FillFields(static_cast<TypeOrExpr*>(node));
			if (auto value = FindField(vl::WString::Unmanaged(L"first")))
			{
		...
		void TypeOrExprVisitor::FillFields(ThrowExpr* node)
		{
			FillFields(static_cast<TypeOrExpr*>(node));
			if (auto value = FindField(vl::WString::Unmanaged(L"arg")))
			{
				auto jsonArray = dynamic_cast<vl::glr::json::JsonArray*>(value);
				if (!jsonArray) throw vl::Exception(L"AST JSON field \"arg\" must be an array.");
				for (auto item : jsonArray->items)
				{
					if (IsNull(item.Obj()))
					{
						node->arg.Add(vl::Ptr<TypeOrExpr>());
					}
					else if (auto jsonObject = item.Cast<vl::glr::json::JsonObject>())
					{
						auto ast = ReadJson(jsonObject.Obj()).Cast<TypeOrExpr>();
						if (!ast) throw vl::Exception(L"AST JSON field \"arg\" contains an incompatible AST type.");
						node->arg.Add(ast);
					}
					else throw vl::Exception(L"AST JSON field \"arg\" contains a non-object, non-null item.");
				}
			}
		}
		...
		vl::Ptr<vl::glr::ParsingAstBase> TypeOrExprVisitor::ReadJson(vl::glr::json::JsonObject* json)
		{
			...
			if (typeName == L"TypeOrExprToResolve")
			{
				...
				static_cast<TypeOrExpr*>(node.Obj())->Accept(static_cast<TypeOrExpr::IVisitor*>(this));
			...
			if (typeName == L"LtExpr")
			{
				auto node = vl::Ptr(new LtExpr);
				JsonObjectScope scope(jsonObjects, json);
				static_cast<TypeOrExpr*>(node.Obj())->Accept(static_cast<TypeOrExpr::IVisitor*>(this));
				ValidateFields(json, typeName);
				return node;
			}
			if (typeName == L"GtExpr")
			{
				auto node = vl::Ptr(new GtExpr);
				JsonObjectScope scope(jsonObjects, json);
				static_cast<TypeOrExpr*>(node.Obj())->Accept(static_cast<TypeOrExpr::IVisitor*>(this));
				ValidateFields(json, typeName);
				return node;
			...
			{
				auto node = vl::Ptr(new ThrowExpr);
				JsonObjectScope scope(jsonObjects, json);
				static_cast<TypeOrExpr*>(node.Obj())->Accept(static_cast<TypeOrExpr::IVisitor*>(this));
				ValidateFields(json, typeName);
				return node;
			}
			if (typeName == L"CommaExpr")
			{
				auto node = vl::Ptr(new CommaExpr);
				JsonObjectScope scope(jsonObjects, json);
				static_cast<TypeOrExpr*>(node.Obj())->Accept(static_cast<TypeOrExpr::IVisitor*>(this));
				ValidateFields(json, typeName);
				return node;
