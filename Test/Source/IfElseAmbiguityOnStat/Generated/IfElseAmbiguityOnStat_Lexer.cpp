...
{
	bool IfElseAmbiguityOnStatTokenDeleter(vl::vint token)
	{
		switch((IfElseAmbiguityOnStatTokens)token)
		{
		case IfElseAmbiguityOnStatTokens::SPACE:
			return true;
		default:
			return false;
		}
	...
	const wchar_t* IfElseAmbiguityOnStatTokenId(IfElseAmbiguityOnStatTokens token)
	{
		...
		return 0 <= index && index < IfElseAmbiguityOnStatTokenCount ? results[index] : nullptr;
	}

	const wchar_t* IfElseAmbiguityOnStatTokenDisplayText(IfElseAmbiguityOnStatTokens token)
	{
		static const wchar_t* results[] = {
			L"{",
			L"}",
	...
	const wchar_t* IfElseAmbiguityOnStatTokenRegex(IfElseAmbiguityOnStatTokens token)
	{
		static const wchar_t* results[] = {
			L"/{",
			L"/}",
	...
	void IfElseAmbiguityOnStatLexerData(vl::stream::IStream& outputStream)
	{
