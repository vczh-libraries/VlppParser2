...
{
	bool IfElseAmbiguityTokenDeleter(vl::vint token)
	{
		switch((IfElseAmbiguityTokens)token)
		{
		case IfElseAmbiguityTokens::SPACE:
			return true;
		default:
			return false;
		}
	...
	const wchar_t* IfElseAmbiguityTokenId(IfElseAmbiguityTokens token)
	{
		...
		return 0 <= index && index < IfElseAmbiguityTokenCount ? results[index] : nullptr;
	}

	const wchar_t* IfElseAmbiguityTokenDisplayText(IfElseAmbiguityTokens token)
	{
		static const wchar_t* results[] = {
			L"{",
			L"}",
	...
	const wchar_t* IfElseAmbiguityTokenRegex(IfElseAmbiguityTokens token)
	{
		static const wchar_t* results[] = {
			L"/{",
			L"/}",
	...
	void IfElseAmbiguityLexerData(vl::stream::IStream& outputStream)
	{
