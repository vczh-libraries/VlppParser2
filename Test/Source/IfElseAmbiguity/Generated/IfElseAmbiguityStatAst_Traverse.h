...
#ifndef VCZH_PARSER2_UNITTEST_IFELSEAMBIGUITY_STATAST_AST_TRAVERSE_VISITOR
#define VCZH_PARSER2_UNITTEST_IFELSEAMBIGUITY_STATAST_AST_TRAVERSE_VISITOR

#include "IfElseAmbiguityStatAst.h"

namespace ifelseambiguity::traverse_visitor
{
