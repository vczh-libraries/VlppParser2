...
#ifndef VCZH_PARSER2_UNITTEST_IFELSEAMBIGUITYONSTAT2_STATAST_AST_JSON
#define VCZH_PARSER2_UNITTEST_IFELSEAMBIGUITYONSTAT2_STATAST_AST_JSON
...
namespace ifelseambiguityonstat2
{
	...
	namespace json_reader
	{
		...
		protected:
			...
			virtual void FillFields(StatToResolve* node);
