...
#ifndef VCZH_PARSER2_UNITTEST_FEATURE_FA_FEATUREAST_AST_JSON
#define VCZH_PARSER2_UNITTEST_FEATURE_FA_FEATUREAST_AST_JSON
...
namespace feature_fa
{
	...
	namespace json_reader
	{
		...
		protected:
			...
			virtual void FillFields(FaFeature* node);
