...
namespace calculator
{
	...
	enum class CalculatorFields : vl::vint32_t
	{
		...
		Call_args = (static_cast<vl::vint32_t>(CalculatorClasses::Call) << 8) + 0,
		...
		LetExpr_result = (static_cast<vl::vint32_t>(CalculatorClasses::LetExpr) << 8) + 1,
		LetExpr_value = (static_cast<vl::vint32_t>(CalculatorClasses::LetExpr) << 8) + 2,
