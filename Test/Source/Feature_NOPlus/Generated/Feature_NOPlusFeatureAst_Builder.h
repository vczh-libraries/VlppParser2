...
#ifndef VCZH_PARSER2_UNITTEST_FEATURE_NOPLUS_FEATUREAST_AST_BUILDER
#define VCZH_PARSER2_UNITTEST_FEATURE_NOPLUS_FEATUREAST_AST_BUILDER

#include "Feature_NOPlusFeatureAst.h"

namespace feature_noplus::builder
{
