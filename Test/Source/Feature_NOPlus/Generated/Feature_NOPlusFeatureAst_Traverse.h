...
#ifndef VCZH_PARSER2_UNITTEST_FEATURE_NOPLUS_FEATUREAST_AST_TRAVERSE_VISITOR
#define VCZH_PARSER2_UNITTEST_FEATURE_NOPLUS_FEATUREAST_AST_TRAVERSE_VISITOR

#include "Feature_NOPlusFeatureAst.h"

namespace feature_noplus::traverse_visitor
{
