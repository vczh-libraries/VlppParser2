...
#ifndef VCZH_PARSER2_UNITTEST_FEATURE_NOPLUS_FEATUREAST_AST
#define VCZH_PARSER2_UNITTEST_FEATURE_NOPLUS_FEATUREAST_AST
...
namespace vl::reflection::description
{
	...
	DECL_TYPE_INFO(feature_noplus::Plus)
	DECL_TYPE_INFO(feature_noplus::Feature)
	DECL_TYPE_INFO(feature_noplus::Feature::IVisitor)
	DECL_TYPE_INFO(feature_noplus::FeatureToResolve)
	DECL_TYPE_INFO(feature_noplus::NestedOptionalFeature)

#ifdef VCZH_DESCRIPTABLEOBJECT_WITH_METADATA

	BEGIN_INTERFACE_PROXY_NOPARENT_SHAREDPTR(feature_noplus::Feature::IVisitor)
		void Visit(feature_noplus::FeatureToResolve* node) override
		{
			INVOKE_INTERFACE_PROXY(Visit, node);
		}

		void Visit(feature_noplus::NestedOptionalFeature* node) override
		{
			INVOKE_INTERFACE_PROXY(Visit, node);
		}

	END_INTERFACE_PROXY(feature_noplus::Feature::IVisitor)

#endif
#endif
	/// <summary>Load all reflectable AST types, only available when <b>VCZH_DEBUG_NO_REFLECTION</b> is off.</summary>
	/// <returns>Returns true if this operation succeeded.</returns>
	extern bool Feature_NOPlusFeatureAstLoadTypes();
}
#endif