...
#ifndef VCZH_PARSER2_UNITTEST_FEATURE_OPTPLUS_FEATUREAST_AST_TRAVERSE_VISITOR
#define VCZH_PARSER2_UNITTEST_FEATURE_OPTPLUS_FEATUREAST_AST_TRAVERSE_VISITOR

#include "Feature_OptPlusFeatureAst.h"

namespace feature_optplus::traverse_visitor
{
