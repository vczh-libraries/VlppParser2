...
#include "Feature_OptPlusFeatureAst_Json.h"
...
namespace feature_optplus
{
	namespace json_visitor
	{
		...
		void FeatureAstVisitor::PrintFields(OptionalFeature* node)
		{
			...
			{
			case feature_optplus::OptionalProprity::Equal:
				WriteString(vl::WString::Unmanaged(L"Equal"));
				break;
			case feature_optplus::OptionalProprity::PreferSkip:
				WriteString(vl::WString::Unmanaged(L"PreferSkip"));
				break;
			case feature_optplus::OptionalProprity::PreferTake:
