...
#ifndef VCZH_PARSER2_UNITTEST_FEATURE_OPTPLUS_FEATUREAST_AST_COPY_VISITOR
#define VCZH_PARSER2_UNITTEST_FEATURE_OPTPLUS_FEATUREAST_AST_COPY_VISITOR

#include "Feature_OptPlusFeatureAst.h"

namespace feature_optplus::copy_visitor
{
