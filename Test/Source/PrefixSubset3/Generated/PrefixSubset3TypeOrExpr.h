...
#ifndef VCZH_PARSER2_UNITTEST_PREFIXSUBSET3_TYPEOREXPR_AST
#define VCZH_PARSER2_UNITTEST_PREFIXSUBSET3_TYPEOREXPR_AST
...
namespace vl
{
	namespace reflection
	{
		namespace description
		{
			...
			DECL_TYPE_INFO(prefixsubset3::TypeOrExpr)
			DECL_TYPE_INFO(prefixsubset3::TypeOrExpr::IVisitor)
			DECL_TYPE_INFO(prefixsubset3::QualifiedName)
			DECL_TYPE_INFO(prefixsubset3::QualifiedName::IVisitor)
			...
			DECL_TYPE_INFO(prefixsubset3::FunctionType)
			DECL_TYPE_INFO(prefixsubset3::TypeOrExprToResolve)

#ifdef VCZH_DESCRIPTABLEOBJECT_WITH_METADATA

			BEGIN_INTERFACE_PROXY_NOPARENT_SHAREDPTR(prefixsubset3::TypeOrExpr::IVisitor)
				void Visit(prefixsubset3::TypeOrExprToResolve* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

				void Visit(prefixsubset3::QualifiedName* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}
				...
				void Visit(prefixsubset3::MulExpr* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

				void Visit(prefixsubset3::ConstType* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

				void Visit(prefixsubset3::PointerType* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

				void Visit(prefixsubset3::FunctionType* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

			END_INTERFACE_PROXY(prefixsubset3::TypeOrExpr::IVisitor)

			BEGIN_INTERFACE_PROXY_NOPARENT_SHAREDPTR(prefixsubset3::QualifiedName::IVisitor)
				void Visit(prefixsubset3::Name* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

				void Visit(prefixsubset3::MemberName* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

			END_INTERFACE_PROXY(prefixsubset3::QualifiedName::IVisitor)

#endif
#endif
			/// <summary>Load all reflectable AST types, only available when <b>VCZH_DEBUG_NO_REFLECTION</b> is off.</summary>
			/// <returns>Returns true if this operation succeeded.</returns>
			extern bool PrefixSubset3TypeOrExprLoadTypes();
		}
	}
}
#endif