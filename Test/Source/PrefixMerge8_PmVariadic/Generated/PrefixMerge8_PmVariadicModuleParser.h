...
namespace prefixmerge8_pmvariadic
{
	enum class ModuleParserStates
	{
		...
		_Expr = 78,
		Module = 87,
		_GenericArgument_LRI_Original = 102,
		_LongTypeArg_LRI_Original = 107,
		_LongType_LRI_Original = 112,
		_ExprArg_LRI_Original = 126,
		_Expr0_LRI_Original = 131,
		_Expr1_LRI_Original = 141,
		_Expr_LRI_Original = 149,
		Module_LRI_Original = 155,
		_Expr0__LongType_LRI_Prefix = 159,
	};
