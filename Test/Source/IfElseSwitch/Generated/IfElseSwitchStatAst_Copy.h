...
#ifndef VCZH_PARSER2_UNITTEST_IFELSESWITCH_STATAST_AST_COPY_VISITOR
#define VCZH_PARSER2_UNITTEST_IFELSESWITCH_STATAST_AST_COPY_VISITOR

#include "IfElseSwitchStatAst.h"

namespace ifelseswitch::copy_visitor
{
