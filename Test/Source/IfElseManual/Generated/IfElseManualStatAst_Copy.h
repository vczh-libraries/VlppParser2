...
#ifndef VCZH_PARSER2_UNITTEST_IFELSEMANUAL_STATAST_AST_COPY_VISITOR
#define VCZH_PARSER2_UNITTEST_IFELSEMANUAL_STATAST_AST_COPY_VISITOR

#include "IfElseManualStatAst.h"

namespace ifelsemanual::copy_visitor
{
