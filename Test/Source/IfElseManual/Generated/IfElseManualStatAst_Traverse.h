...
#ifndef VCZH_PARSER2_UNITTEST_IFELSEMANUAL_STATAST_AST_TRAVERSE_VISITOR
#define VCZH_PARSER2_UNITTEST_IFELSEMANUAL_STATAST_AST_TRAVERSE_VISITOR

#include "IfElseManualStatAst.h"

namespace ifelsemanual::traverse_visitor
{
