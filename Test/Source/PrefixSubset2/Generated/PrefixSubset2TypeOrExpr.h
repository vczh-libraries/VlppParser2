...
#ifndef VCZH_PARSER2_UNITTEST_PREFIXSUBSET2_TYPEOREXPR_AST
#define VCZH_PARSER2_UNITTEST_PREFIXSUBSET2_TYPEOREXPR_AST
...
namespace vl
{
	namespace reflection
	{
		namespace description
		{
			...
			DECL_TYPE_INFO(prefixsubset2::TypeOrExpr)
			DECL_TYPE_INFO(prefixsubset2::TypeOrExpr::IVisitor)
			DECL_TYPE_INFO(prefixsubset2::QualifiedName)
			DECL_TYPE_INFO(prefixsubset2::QualifiedName::IVisitor)
			DECL_TYPE_INFO(prefixsubset2::Name)
			DECL_TYPE_INFO(prefixsubset2::MemberName)
			DECL_TYPE_INFO(prefixsubset2::CallExpr)
			DECL_TYPE_INFO(prefixsubset2::MulExpr)
			DECL_TYPE_INFO(prefixsubset2::ConstType)
			DECL_TYPE_INFO(prefixsubset2::PointerType)
			DECL_TYPE_INFO(prefixsubset2::FunctionType)
			DECL_TYPE_INFO(prefixsubset2::TypeOrExprToResolve)

#ifdef VCZH_DESCRIPTABLEOBJECT_WITH_METADATA

			BEGIN_INTERFACE_PROXY_NOPARENT_SHAREDPTR(prefixsubset2::TypeOrExpr::IVisitor)
				void Visit(prefixsubset2::TypeOrExprToResolve* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

				void Visit(prefixsubset2::QualifiedName* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

				void Visit(prefixsubset2::CallExpr* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

				void Visit(prefixsubset2::MulExpr* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

				void Visit(prefixsubset2::ConstType* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

				void Visit(prefixsubset2::PointerType* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

				void Visit(prefixsubset2::FunctionType* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

			END_INTERFACE_PROXY(prefixsubset2::TypeOrExpr::IVisitor)

			BEGIN_INTERFACE_PROXY_NOPARENT_SHAREDPTR(prefixsubset2::QualifiedName::IVisitor)
				void Visit(prefixsubset2::Name* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

				void Visit(prefixsubset2::MemberName* node) override
				{
					INVOKE_INTERFACE_PROXY(Visit, node);
				}

			END_INTERFACE_PROXY(prefixsubset2::QualifiedName::IVisitor)

#endif
#endif
			/// <summary>Load all reflectable AST types, only available when <b>VCZH_DEBUG_NO_REFLECTION</b> is off.</summary>
			/// <returns>Returns true if this operation succeeded.</returns>
			extern bool PrefixSubset2TypeOrExprLoadTypes();
		}
	}
}
#endif