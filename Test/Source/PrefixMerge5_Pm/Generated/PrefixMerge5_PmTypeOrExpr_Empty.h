...
#ifndef VCZH_PARSER2_UNITTEST_PREFIXMERGE5_PM_TYPEOREXPR_AST_EMPTY_VISITOR
#define VCZH_PARSER2_UNITTEST_PREFIXMERGE5_PM_TYPEOREXPR_AST_EMPTY_VISITOR

#include "PrefixMerge5_PmTypeOrExpr.h"

namespace prefixmerge5_pm::empty_visitor
{
