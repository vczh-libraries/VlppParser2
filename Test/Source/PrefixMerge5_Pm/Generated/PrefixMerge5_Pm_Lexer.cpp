...
{
	bool PrefixMerge5_PmTokenDeleter(vl::vint token)
	{
		switch((PrefixMerge5_PmTokens)token)
		{
		case PrefixMerge5_PmTokens::SPACE:
			return true;
		default:
			return false;
		}
	...
	const wchar_t* PrefixMerge5_PmTokenId(PrefixMerge5_PmTokens token)
	{
		...
		return 0 <= index && index < PrefixMerge5_PmTokenCount ? results[index] : nullptr;
	}

	const wchar_t* PrefixMerge5_PmTokenDisplayText(PrefixMerge5_PmTokens token)
	{
		static const wchar_t* results[] = {
			L"(",
			L")",
	...
	const wchar_t* PrefixMerge5_PmTokenRegex(PrefixMerge5_PmTokens token)
	{
		static const wchar_t* results[] = {
			L"/(",
			L"/)",
	...
	void PrefixMerge5_PmLexerData(vl::stream::IStream& outputStream)
	{
