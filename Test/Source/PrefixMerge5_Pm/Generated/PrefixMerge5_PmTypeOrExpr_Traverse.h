...
#ifndef VCZH_PARSER2_UNITTEST_PREFIXMERGE5_PM_TYPEOREXPR_AST_TRAVERSE_VISITOR
#define VCZH_PARSER2_UNITTEST_PREFIXMERGE5_PM_TYPEOREXPR_AST_TRAVERSE_VISITOR

#include "PrefixMerge5_PmTypeOrExpr.h"

namespace prefixmerge5_pm::traverse_visitor
{
