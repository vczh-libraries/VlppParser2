...
namespace cpp_parser
{
	enum class ParserStates
	{
		...
		_TypeStartsWithKeyword_LRI_Original = 1735,
		_Type_LRI_Original = 1742,
		_Expr_NoComma_LRI_Original = 1749,
		_Expr_LRI_Original = 1752,
		_Expr_Argument_LRI_Original = 1755,
		_TypeOrExpr_NoComma_NoGT_LRI_Original = 1760,
		_TypeOrExpr_LRI_Original = 1763,
		_TypeOrExpr_NoComma_Raw_SWITCH_COMBINED_LRI_Original = 1766,
		_TypeOrExpr_NoComma_Raw_SWITCH_0allow_GT_LRI_Original = 1769,
		_TypeOrExpr_Raw_SWITCH_COMBINED_LRI_Original = 1773,
		_TypeOrExpr_Raw_SWITCH_1allow_GT_LRI_Original = 1776,
	};
