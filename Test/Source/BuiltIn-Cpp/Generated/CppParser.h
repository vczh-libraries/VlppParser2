...
namespace cpp_parser
{
	enum class ParserStates
	{
		...
		_InnerDeclaratorInnerWithName = 685,
		_DeclaratorInnerWithoutName = 689,
		_DeclaratorInnerOptionalName = 694,
		_DeclaratorInnerWithName = 700,
		_DeclaratorWithoutName = 706,
		_DeclaratorOptionalName = 714,
		_DeclaratorWithName = 722,
		_TypeOrDeclarator = 727,
		_TypeOnly = 732,
		_Type = 736,
		_ExprOnly_NoComma = 741,
		_Expr_NoComma = 748,
		_ExprOnly = 753,
		_Expr = 761,
		_TypeOrExpr_NoComma_NoLT = 766,
		_TypeOrExpr = 773,
		_File = 780,
	};
