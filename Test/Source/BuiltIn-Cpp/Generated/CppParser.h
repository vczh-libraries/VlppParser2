...
namespace cpp_parser
{
	enum class ParserStates
	{
		...
		_DeclaratorFunctionParameters = 619,
		_DeclaratorFunctionPart = 627,
		_DeclaratorArrayPart = 632,
		_DeclaratorId = 637,
		_DeclaratorBeforeInner = 641,
		_DeclaratorAfterInner = 648,
		_InnerDeclaratorWithoutName = 653,
		_InnerDeclaratorInnerOptionalName = 657,
		_InnerDeclaratorInnerWithName = 661,
		_DeclaratorInnerWithoutName = 665,
		_DeclaratorInnerOptionalName = 670,
		_DeclaratorInnerWithName = 676,
		_DeclaratorWithoutName = 682,
		_DeclaratorOptionalName = 690,
		_DeclaratorWithName = 698,
		_TypeOrDeclarator = 703,
		_TypeOnly = 708,
		_Type = 712,
		_ExprOnly_NoComma = 717,
		_Expr_NoComma = 724,
		_ExprOnly = 729,
		_Expr = 737,
		_TypeOrExpr_NoComma_NoLT = 742,
		_TypeOrExpr = 749,
		_File = 756,
	};
