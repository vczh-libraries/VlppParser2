...
namespace cpp_parser
{
	enum class ParserStates
	{
		...
		_LongType = 549,
		_AdvancedTypeNoCVNoMember = 558,
		_AdvancedTypeNoMember = 571,
		...
		_DeclaratorFunctionPart = 622,
		_DeclaratorArrayPart = 627,
		_DeclaratorId = 632,
		_DeclaratorBeforeInner = 636,
		_DeclaratorAfterInner = 643,
		_DeclaratorInnerWithoutName = 648,
		_DeclaratorInnerOptionalName = 653,
		_DeclaratorInnerWithName = 659,
		_DeclaratorWithoutName = 665,
		_DeclaratorOptionalName = 673,
		_DeclaratorWithName = 681,
		_TypeOrDeclarator = 686,
		_TypeOnly = 691,
		_Type = 695,
		_ExprOnly_NoComma = 700,
		_Expr_NoComma = 707,
		_ExprOnly = 712,
		_Expr = 720,
		_TypeOrExpr_NoComma_NoLT = 725,
		_TypeOrExpr = 732,
		_File = 739,
	};
