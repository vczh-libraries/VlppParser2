...
namespace cpp_parser
{
	enum class ParserStates
	{
		...
		_DeclaratorFunctionParameters = 620,
		_FunctionKeyword = 628,
		_DeclaratorFunctionPart = 648,
		...
		_InnerDeclaratorInnerWithName = 686,
		_DeclaratorInnerWithoutName = 690,
		_DeclaratorInnerOptionalName = 696,
		_DeclaratorInnerWithName = 704,
		_DeclaratorWithoutName = 711,
		_DeclaratorOptionalName = 719,
		_DeclaratorWithName = 727,
		_TypeOrDeclarator = 732,
		_TypeOnly = 737,
		_Type = 741,
		_ExprOnly_NoComma = 746,
		_Expr_NoComma = 753,
		_ExprOnly = 758,
		_Expr = 766,
		_TypeOrExpr_NoComma_NoLT = 771,
		_TypeOrExpr = 778,
		_File = 785,
	};
