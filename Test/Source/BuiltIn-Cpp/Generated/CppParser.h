...
namespace cpp_parser
{
	enum class ParserStates
	{
		...
		_ShortTypeStartsWithKeywordBeforeDeclarator = 515,
		...
		_ShortTypeStartsWithKeywordBeforeDeclarator_LRI_Isolated_1 = 1626,
		_ShortTypeStartsWithKeywordBeforeDeclarator_LRI_Isolated_2 = 1630,
		...
		_ShortTypeStartsWithKeywordBeforeDeclarator_LRI_Original = 1992,
