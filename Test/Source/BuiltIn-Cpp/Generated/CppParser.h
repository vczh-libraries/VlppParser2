...
namespace cpp_parser
{
	enum class ParserStates
	{
		...
		_LongType = 549,
		_AdvancedTypeNoCV = 558,
		_AdvancedType = 569,
		_DeclaratorKeyword = 574,
		_DeclaratorAKFirst = 594,
		_DeclaratorAKFollow = 598,
		_Declarator = 602,
		_TypeOrDeclarator = 606,
		_TypeOnly = 611,
		_Type = 615,
		_ExprOnly_NoComma = 620,
		_Expr_NoComma = 627,
		_ExprOnly = 632,
		_Expr = 640,
		_TypeOrExpr_NoComma_NoLT = 645,
		_TypeOrExpr = 652,
		_File = 659,
	};
