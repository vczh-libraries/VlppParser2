...
namespace cpp_parser
{
	enum class ParserStates
	{
		...
		_DeclaratorFunctionPart = 655,
		_DeclaratorArrayPart = 663,
		_DeclaratorId = 668,
		_DeclaratorBeforeInner = 672,
		_DeclaratorAfterInner = 679,
		_InnerDeclaratorWithoutName = 684,
		_InnerDeclaratorInnerOptionalName = 688,
		_InnerDeclaratorInnerWithName = 692,
		_DeclaratorInnerWithoutName = 696,
		_DeclaratorInnerOptionalName = 702,
		_DeclaratorInnerWithName = 710,
		_DeclaratorWithoutName = 717,
		_DeclaratorOptionalName = 725,
		_DeclaratorWithName = 733,
		_TypeOrDeclarator = 738,
		_TypeOnly = 743,
		_Type = 751,
