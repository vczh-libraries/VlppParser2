...
namespace cpp_parser
{
	...
	enum class CppFields : vl::vint32_t
	{
		...
		SizeofExpr_argument = 45,
		SizeofExpr_variadic = 46,
		StringLiteral_fragments = 47,
		StringLiteralFragment_kind = 48,
		StringLiteralFragment_literal = 49,
		SysFuncExpr_argument = 50,
		SysFuncExpr_keyword = 51,
		SysFuncExpr_variadic = 52,
		ThrowExpr_argument = 53,
		VolatileType_type = 54,
	};
