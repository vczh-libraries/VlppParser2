...
namespace cpp_parser
{
	enum class CppClasses : vl::vint32_t
	{
		...
		VarBraceInit = 81,
		VarInit = 82,
		VarParanthesisInit = 83,
		VarStatInit = 84,
		VarValueInit = 85,
		VariablesDeclaration = 86,
		VariadicExpr = 87,
		VolatileType = 88,
		WhileStat = 89,
		__LeaveStat = 90,
	...
	enum class CppFields : vl::vint32_t
	{
		...
		VarBraceInit_arguments = 153,
		VarParanthesisInit_arguments = 154,
		VarStatInit_stat = 155,
		VarValueInit_expr = 156,
		VariablesDeclaration_firstVarPart = 157,
		VariablesDeclaration_keywords = 158,
		VariablesDeclaration_type = 159,
		VariadicExpr_operand = 160,
		VariadicExpr_variadic = 161,
		VolatileType_type = 162,
		WhileStat_condition = 163,
		WhileStat_stat = 164,
		__TryStat_exceptStat = 165,
		__TryStat_filter = 166,
		__TryStat_finallyStat = 167,
		__TryStat_tryStat = 168,
	};
