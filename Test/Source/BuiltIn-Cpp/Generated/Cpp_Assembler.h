...
namespace cpp_parser
{
	enum class CppClasses : vl::vint32_t
	{
		...
		DeclaratorFunctionPartCommon = 21,
		DeclaratorFunctionPartToResolve = 22,
		DeclaratorKeyword = 23,
		DeclaratorType = 24,
		DeclaratorVariablePart = 25,
		DeclaratorVariablePartCommon = 26,
		DeclaratorVariablePartToResolve = 27,
		DefaultStat = 28,
		DeleteExpr = 29,
		DoWhileStat = 30,
		EmptyStat = 31,
	...
	enum class CppFields : vl::vint32_t
	{
		...
		DeclaratorVariablePartCommon_declarator = 50,
		DeclaratorVariablePartCommon_init = 51,
		DeclaratorVariablePartCommon_nextVarPart = 52,
