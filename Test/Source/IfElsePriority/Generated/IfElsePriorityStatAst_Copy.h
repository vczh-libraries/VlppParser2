...
#ifndef VCZH_PARSER2_UNITTEST_IFELSEPRIORITY_STATAST_AST_COPY_VISITOR
#define VCZH_PARSER2_UNITTEST_IFELSEPRIORITY_STATAST_AST_COPY_VISITOR

#include "IfElsePriorityStatAst.h"

namespace ifelsepriority::copy_visitor
{
