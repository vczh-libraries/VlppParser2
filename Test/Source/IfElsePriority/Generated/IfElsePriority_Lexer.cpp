...
{
	bool IfElsePriorityTokenDeleter(vl::vint token)
	{
		switch((IfElsePriorityTokens)token)
		{
		case IfElsePriorityTokens::SPACE:
			return true;
		default:
			return false;
		}
	...
	const wchar_t* IfElsePriorityTokenId(IfElsePriorityTokens token)
	{
		...
		return 0 <= index && index < IfElsePriorityTokenCount ? results[index] : nullptr;
	}

	const wchar_t* IfElsePriorityTokenDisplayText(IfElsePriorityTokens token)
	{
		static const wchar_t* results[] = {
			L"{",
			L"}",
	...
	const wchar_t* IfElsePriorityTokenRegex(IfElsePriorityTokens token)
	{
		static const wchar_t* results[] = {
			L"/{",
			L"/}",
	...
	void IfElsePriorityLexerData(vl::stream::IStream& outputStream)
	{
