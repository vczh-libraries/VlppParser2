...
#ifndef VCZH_PARSER2_UNITTEST_IFELSEPRIORITY_STATAST_AST_TRAVERSE_VISITOR
#define VCZH_PARSER2_UNITTEST_IFELSEPRIORITY_STATAST_AST_TRAVERSE_VISITOR

#include "IfElsePriorityStatAst.h"

namespace ifelsepriority::traverse_visitor
{
