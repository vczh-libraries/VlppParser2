...
#ifndef VCZH_PARSER2_UNITTEST_PREFIXMERGE1_LRI_TYPEOREXPR_AST_JSON_VISITOR
#define VCZH_PARSER2_UNITTEST_PREFIXMERGE1_LRI_TYPEOREXPR_AST_JSON_VISITOR

#include "PrefixMerge1_LriTypeOrExpr.h"

namespace prefixmerge1_lri::json_visitor
{
