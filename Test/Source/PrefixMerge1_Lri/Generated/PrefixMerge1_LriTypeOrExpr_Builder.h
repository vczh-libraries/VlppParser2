...
#ifndef VCZH_PARSER2_UNITTEST_PREFIXMERGE1_LRI_TYPEOREXPR_AST_BUILDER
#define VCZH_PARSER2_UNITTEST_PREFIXMERGE1_LRI_TYPEOREXPR_AST_BUILDER

#include "PrefixMerge1_LriTypeOrExpr.h"

namespace prefixmerge1_lri::builder
{
