...
{
	bool PrefixMerge2_LriRequiredTokenDeleter(vl::vint token)
	{
		switch((PrefixMerge2_LriRequiredTokens)token)
		{
		case PrefixMerge2_LriRequiredTokens::SPACE:
			return true;
		default:
			return false;
		}
	...
	const wchar_t* PrefixMerge2_LriRequiredTokenId(PrefixMerge2_LriRequiredTokens token)
	{
		...
		return 0 <= index && index < PrefixMerge2_LriRequiredTokenCount ? results[index] : nullptr;
	}

	const wchar_t* PrefixMerge2_LriRequiredTokenDisplayText(PrefixMerge2_LriRequiredTokens token)
	{
		static const wchar_t* results[] = {
			L"(",
			L")",
	...
	const wchar_t* PrefixMerge2_LriRequiredTokenRegex(PrefixMerge2_LriRequiredTokens token)
	{
		static const wchar_t* results[] = {
			L"/(",
			L"/)",
	...
	void PrefixMerge2_LriRequiredLexerData(vl::stream::IStream& outputStream)
	{
