...
#ifndef VCZH_PARSER2_UNITTEST_FEATURE_NOMINUS_FEATUREAST_AST_COPY_VISITOR
#define VCZH_PARSER2_UNITTEST_FEATURE_NOMINUS_FEATUREAST_AST_COPY_VISITOR

#include "Feature_NOMinusFeatureAst.h"

namespace feature_nominus::copy_visitor
{
