...
#ifndef VCZH_PARSER2_UNITTEST_FEATURE_OPTMINUS_FEATUREAST_AST_TRAVERSE_VISITOR
#define VCZH_PARSER2_UNITTEST_FEATURE_OPTMINUS_FEATUREAST_AST_TRAVERSE_VISITOR

#include "Feature_OptMinusFeatureAst.h"

namespace feature_optminus::traverse_visitor
{
