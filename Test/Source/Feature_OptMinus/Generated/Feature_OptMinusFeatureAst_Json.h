...
#ifndef VCZH_PARSER2_UNITTEST_FEATURE_OPTMINUS_FEATUREAST_AST_JSON
#define VCZH_PARSER2_UNITTEST_FEATURE_OPTMINUS_FEATUREAST_AST_JSON
...
namespace feature_optminus
{
	...
	namespace json_reader
	{
		...
		protected:
			...
			virtual void FillFields(OptionalFeature* node);
