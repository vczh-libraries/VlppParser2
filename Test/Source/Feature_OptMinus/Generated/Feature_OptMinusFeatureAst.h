...
#ifndef VCZH_PARSER2_UNITTEST_FEATURE_OPTMINUS_FEATUREAST_AST
#define VCZH_PARSER2_UNITTEST_FEATURE_OPTMINUS_FEATUREAST_AST
...
namespace vl::reflection::description
{
	...
	DECL_TYPE_INFO(feature_optminus::Plus)
	DECL_TYPE_INFO(feature_optminus::Feature)
	DECL_TYPE_INFO(feature_optminus::Feature::IVisitor)
	DECL_TYPE_INFO(feature_optminus::FeatureToResolve)
	DECL_TYPE_INFO(feature_optminus::OptionalProprity)
	DECL_TYPE_INFO(feature_optminus::OptionalFeature)

#ifdef VCZH_DESCRIPTABLEOBJECT_WITH_METADATA

	BEGIN_INTERFACE_PROXY_NOPARENT_SHAREDPTR(feature_optminus::Feature::IVisitor)
		void Visit(feature_optminus::FeatureToResolve* node) override
		{
			INVOKE_INTERFACE_PROXY(Visit, node);
		}

		void Visit(feature_optminus::OptionalFeature* node) override
		{
			INVOKE_INTERFACE_PROXY(Visit, node);
		}

	END_INTERFACE_PROXY(feature_optminus::Feature::IVisitor)

#endif
#endif
	/// <summary>Load all reflectable AST types, only available when <b>VCZH_DEBUG_NO_REFLECTION</b> is off.</summary>
	/// <returns>Returns true if this operation succeeded.</returns>
	extern bool Feature_OptMinusFeatureAstLoadTypes();
}
#endif