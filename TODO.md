...
1. [x] `ParserTest_ParserGen_Compiler`
   1. [ ] Prepare more parser test cases for advanced features
      ...
      5. [x] `FeatureTest` (Test syntax features)
   2. [ ] Generate JSON parser
   3. [ ] Generate XML parser
   4. [ ] Generate Workflow parser
1. [x] `ParserTest_ParserGen_Generated`
   1. [x] Prepare more parser test cases (including `Calculator/Generated`).
   2. [x] Run all parsers.
   3. [ ] Test JSON parser. (using manual test cases, and test cases generated by other parser output)
   4. [ ] Test XML parser. (using manual test cases, and all xml files in Release repo)
   5. [ ] Test Workflow parser. (using manual test cases, and all test cases in Workflow repo)
